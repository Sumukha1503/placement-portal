    ...
    try {
      ...
      setAnalyticsData({
        placementByBranch: [
          ...
          { branch: 'ECE', placed: 70, total: 90 },
          { branch: 'ME', placed: 60, total: 85 },
          { branch: 'EEE', placed: 65, total: 80 }
        ],
        packageDistribution: [
        ...
        yearlyTrend: [
          ...
          { year: '2025', placed: 280, avgPackage: 7.8 }
        ],
        topCompanies: [
    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-xl" style={{ background: 'var(--bg-secondary)' }}>
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={analyticsData.placementByBranch}>
            <CartesianGrid strokeDasharray="3 3" stroke="var(--border)" />
            <XAxis dataKey="branch" stroke="var(--text-secondary)" />
