...
const Reports = () => {
  ...
  const handleGenerateReport = async (format) => {
    ...
    try {
      ...
      link.href = url;
      link.setAttribute('download', `department-report.${format === 'excel' ? 'xlsx' : 'pdf'}`);
  ...
  const reportTypes = [
    { value: 'student-wise', label: 'Student-wise Report', description: 'Individual student placement details' },
    { value: 'company-wise', label: 'Company-wise Report', description: 'Recruitment statistics by company' },
    { value: 'package-wise', label: 'Package-wise Report', description: 'Package distribution analysis' },
    { value: 'summary', label: 'Summary Report', description: 'Overall placement statistics' }
  ];
